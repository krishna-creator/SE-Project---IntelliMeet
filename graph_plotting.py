...
def load_audio_transcripts_data(input_file_name_audio):
    ...
    file_object = open("meeting_notes.txt", "w")
...
def use_case_1():
    ...
    print("Server's unattentiveness timings:")
    print(server_una_time)
    #print(server_sequence_ids)
    print("Clinet's unattentiveness timings:")
    ...
    plt.savefig('server_graph.png', dpi =300)
    ...
    plt.tick_params(axis='x', which='major', labelsize=5)
    plt.savefig('client_graph.png', dpi =300)
    ...
    if len(server_una_time)>0:
        ...
        email_triggering(server_email_body_text, h_email, "server_graph.png")
    ...
    if len(client_una_time)>0:
        ...
        email_triggering(client_email_body_text, p_email, "client_graph.png")
